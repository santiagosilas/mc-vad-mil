...
if __name__ == '__main__':
    ...
    save_path = os.path.join(args.model_name, args.feature_pretrain_model, f"{args.dataset_name_camA}-{args.dataset_name_camB}-{args.dataset_name_camC}", 
    ...
    ckpt_path = os.path.join(os.path.join(os.path.join(args.dataset_path, f"outputs-{args.dataset_name_camA}-{args.dataset_name_camB}-{args.dataset_name_camC}"), "ckpt"), save_path)
    if not os.path.exists(ckpt_path):
        os.makedirs(ckpt_path)
    print(ckpt_path)
    
    logs_path = os.path.join(os.path.join(os.path.join(args.dataset_path, f"outputs-{args.dataset_name_camA}-{args.dataset_name_camB}-{args.dataset_name_camC}"), "logs"), save_path)
    ...
    results_path = os.path.join(os.path.join(os.path.join(args.dataset_path, f"outputs-{args.dataset_name_camA}-{args.dataset_name_camB}-{args.dataset_name_camC}"), "result"), save_path)
    print(results_path)
