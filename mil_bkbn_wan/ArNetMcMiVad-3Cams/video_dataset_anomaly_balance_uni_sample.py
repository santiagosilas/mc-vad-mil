...
class dataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.train:
            ...
            return [anomaly_features_camA, normaly_features_camA],[anomaly_features_camB, normaly_features_camB],[anomaly_features_camC, normaly_features_camC], [anomaly_label, normaly_label], [train_video_name, start_index_camA, len_index_camA]
        else:
            ...
            return self.feature_camA,self.feature_camB,self.feature_camC, data_video_name
