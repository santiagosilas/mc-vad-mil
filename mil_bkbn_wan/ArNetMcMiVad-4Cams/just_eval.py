...
if __name__ == '__main__':
    ...
    results = eval_p(epoch = -1, itr=-1, dataset_camA = args.dataset_name_camA, dataset_camB = args.dataset_name_camB,dataset_camC = args.dataset_name_camC,dataset_camD = args.dataset_name_camD, 
