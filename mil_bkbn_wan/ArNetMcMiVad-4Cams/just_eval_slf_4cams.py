...
from test import test_slf_4cams
...
if __name__ == '__main__':
    ...
    test_result_dict = test_slf_4cams(test_loader, model1, model2, model3, model4, device, args)
    
    results = eval_p(epoch = -1, itr=-1, 
                     dataset_camA = args.dataset_name_camA, dataset_camB = args.dataset_name_camB,
                     dataset_camC = args.dataset_name_camC, dataset_camD = args.dataset_name_camD, 
