"""
Run python export_pets_to_bkbn_sultani.py
to export the *npy train files to the MIL Backbone Target Format for Sultani
"""
...
splits_folder = base_path = f"/media/dev/LaCie/MC-VAD-MIL-DATA/center-crop/pets2009-relabeled-i3d/"
output_folder = f'/media/dev/LaCie/MC-VAD-MIL-OUT/pets2009-relabeled-i3d-milbkbn-sultani'

splits_folder = base_path = f"/media/dev/LaCie/MC-VAD-MIL-OUT/pets2009-relabeled-i3d-featconc-2cams/"
output_folder = f'/media/dev/LaCie/MC-VAD-MIL-OUT/pets2009-relabeled-i3d-featconc-2cams-milbkbn-sultani'

splits_folder = base_path = f"/media/dev/LaCie/MC-VAD-MIL-OUT/pets2009-relabeled-i3d-featconc-3cams/"
output_folder = f'/media/dev/LaCie/MC-VAD-MIL-OUT/pets2009-relabeled-i3d-featconc-3cams-milbkbn-sultani'

splits_folder = base_path = f"/media/dev/LaCie/MC-VAD-MIL-OUT/pets2009-relabeled-i3d-featconc-4cams/"
output_folder = f'/media/dev/LaCie/MC-VAD-MIL-OUT/pets2009-relabeled-i3d-featconc-4cams-milbkbn-sultani'
