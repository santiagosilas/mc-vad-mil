...
views = ["001","002","003","004"]

for view in views:
    for mode in ["rgb", "flow", "combine"]:
        dataset = f"pets2009-relabeled-{feat}-milbkbn-wan"
        print(view, mode)
        
        train_path = f'/media/dev/LaCie/MC-VAD-MIL-DATA/center-crop/pets2009-relabeled-i3d/pets2009-{mode}-seed-1-train-view-{view}.npy'
        test_path = f'/media/dev/LaCie/MC-VAD-MIL-DATA/center-crop/pets2009-relabeled-i3d/pets2009-{mode}-seed-1-test-view-{view}.npy'
