...
for view in ["1","2","3","4","5",]:
    for mode in ["rgb", "flow", "combine"]:
        dataset = f"hqfs-relabeled-{feat}-milbkbn-wan"
        print(view, mode)
        
        train_path = f'/media/dev/LaCie/MC-VAD-MIL-DATA/center-crop/hqfs-relabeled-i3d/hqfs-i3d-{mode}-train-cam{view}.npy'
        test_path = f'/media/dev/LaCie/MC-VAD-MIL-DATA/center-crop/hqfs-relabeled-i3d/hqfs-i3d-{mode}-test-cam{view}.npy'
