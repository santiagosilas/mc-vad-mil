...
splits_folder = base_path = f"/media/dev/LaCie/MC-VAD-MIL-DATA/center-crop/upfall-i3d/"
output_folder = f'/media/dev/LaCie/MC-VAD-MIL-OUT/upfall-i3d-sultani-format'

splits_folder = base_path = f"/media/dev/LaCie/MC-VAD-MIL-OUT/upfall-i3d-featconc-2cams/"
output_folder = f'/media/dev/LaCie/MC-VAD-MIL-OUT/upfall-i3d-featconc-2cams-sultani-format'
